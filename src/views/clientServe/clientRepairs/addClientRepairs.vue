  ...
  <div class="pageContainer" ref="pageContainer">
    ...
    <div ref="pageSearch" class="pageSearch">
      <el-collapse v-model="activeNames">
        <el-collapse-item title="添加客户工单" name="1">
          <div class="searchRow">
            <el-form
              :model="form"
              :rules="rules"
...
<script>
// 获取所有字典/产品线对应的型号/获取省份对应的城市/图片上传
import {
  getAllDict,
  getModel,
  getCity,
...
// 验证序列号/添加派工单/查询客户管理列表/验证序列号是否已报修
import {
  isExist,
  productRepairAdmin,
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //token
      tokenurl:Cookies.get("vue_admin_template_token"),
      // 图片列表
      imagesList: [],
      // 接收图片路径的数组
      imgURLList: [],
  ...
  methods: {
    ...
    fetchAllDict() {
      ...
      let data =
        "POSITION,DEPARTMENT,PRODUCT_LINE,EQUI_MODEL,FAULT_TYPE,APPLY_TYPE,PROVINCE,CITY";
