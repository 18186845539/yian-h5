        ...
        <el-collapse-item :title="title" name="1">
          <div class="searchRow">
            <el-form
              ...
              class="demo-ruleForm"
            >
              <el-form-item label="产品名称：" prop="lable">
                <el-input v-model="form.lable"></el-input>
              </el-form-item>

              <!-- <el-form-item label="类型：" prop="value">
                <el-input v-model="form.value" @blur="queryValue()"></el-input> 如：无影灯 = wyd ;  配件 = wyd00001
              </el-form-item> -->
...
<script>
// 添加产品字典/根据id查询字典数据/修改字典信息保存/根据type查询value是否存在
import {
  addDicCode,
  queryDicById,
  updateDicCode,
    ...
    addOrEdit() {
      ...
      if (id) {
        ...
        queryDicById(data).then(res => {
          ...
          _this.form.type = "PARTS_TYPE_TWO";
