        ...
        <el-collapse-item :title="title" name="1">
          <div class="searchRow">
            <el-form
              ...
              class="demo-ruleForm"
            >
              <el-form-item label="配件名称：" prop="lable">
                <el-input v-model="form.lable"></el-input>
              </el-form-item>

              <!-- <el-form-item label="类型：" prop="value">
                <el-input v-model="form.value" @blur="queryValue()"></el-input> 如：无影灯型号01 = wydxh ;无影灯型号01 = wydxh00001
              </el-form-item> -->

              <el-form-item label="配件型号备注：" >
                <el-input
...
<script>
// 添加二级类型字典/根据id查询字典数据/修改字典信息保存/根据type查询value是否存在
import {
  addDicCode,
  queryDicById,
  updateDicCode,
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        // 配件型号备注验证
        remarks: [
          { required: true, message: "请输入配件型号备注", trigger: "blur" },
          {
            min: 1,
            max: 200,
    ...
    addOrEdit() {
      ...
      if (id) {
        ...
        queryDicById(data).then(res => {
          ...
          _this.form.type = "PARTS_TYPE_THREE";
